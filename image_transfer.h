...
// Use a standard C type instead of Windows-specific DWORD to avoid
// compilation errors when Windows headers are not included.
const unsigned long SMAX = 170000000UL; 
