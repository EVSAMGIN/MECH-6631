...
void compute_relative_angle(double ic1, double jc1, double ic2, double jc2, double &theta1, double &theta2)
// compute angles from origin to each centroid position
// theta1 - angle to centroid1 in degrees
// theta2 - angle to centroid2 in degrees
{
	theta1 = atan2(jc1, ic1) * 180.0 / 3.14159265;
	theta2 = atan2(jc2, ic2) * 180.0 / 3.14159265;
}
